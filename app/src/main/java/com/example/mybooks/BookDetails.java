...
public class BookDetails extends AppCompatActivity {
    ...
    private CollectionsFragment collectionsFragment = new CollectionsFragment(collections);
        ...
        btnAddToCollection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedCollection.equals(getString(R.string.add_to_favourites)))
                {
                    ...
                    Toast.makeText(getBaseContext(), "Book added to " + getString(R.string.favourites_collection), Toast.LENGTH_LONG).show();
                    Log.i(log_tag, "Size of favourites: " + collections.getFavourites().size());

                } else if (selectedCollection.equals(getString(R.string.add_to_want_to_read)))
                {
                    collections.addToWantToRead(book);
                    Toast.makeText(getBaseContext(), "Book added to " + getString(R.string.wantToRead_collection), Toast.LENGTH_LONG).show();

                } else if (selectedCollection.equals(getString(R.string.add_to_currently_reading)))
                {
                    collections.addToCurrentlyReading(book);
                    Toast.makeText(getBaseContext(), "Book added to " + getString(R.string.currentlyReading_collection), Toast.LENGTH_LONG).show();

                } else if (selectedCollection.equals(getString(R.string.add_to_read)))
                {
                    collections.addToRead(book);
                    Toast.makeText(getBaseContext(), "Book added to " + getString(R.string.read_collection), Toast.LENGTH_LONG).show();
